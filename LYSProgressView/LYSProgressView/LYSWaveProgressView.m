...
@implementation LYSWaveProgressView
...
-(void)initConfig{
    ...
    _bgFillColor = [UIColor groupTableViewBackgroundColor];
    
    _waveTopFillColor = [UIColor colorWithRed:0/255.0 green:191/255.0 blue:255/255.0 alpha:1.0f];
    
    _waveBottomFillColor = [UIColor colorWithRed:0/255.0 green:191/255.0 blue:255/255.0 alpha:0.4f];
...
- (void)drawRect:(CGRect)rect
{
    ...
    [self.bgFillColor setFill];
    [path fill];
    [path addClip];
    
    //绘制两个波形图
    [self drawWaveColor:self.waveTopFillColor offsetx:0 offsety:0];
    [self drawWaveColor:self.waveBottomFillColor offsetx:_wave_h_distance offsety:_wave_v_distance];
}
